...
tags: [Codex, coding agent, visual-essay, source-notes, tool-execution, workspace]
category: Codex
...
- 上一章：[Sandbox 与权限边界](../05-sandbox-and-permissions/)
- 下一章：[Subagent 架构](../07-subagent-architecture/)
